...
public class CommonClientConfigs {
    ...
    public static final Long DEFAULT_SOCKET_CONNECTION_SETUP_TIMEOUT_MS = 1000 * 1000L;
    ...
    public static final Long DEFAULT_SOCKET_CONNECTION_SETUP_TIMEOUT_MAX_MS = 3000 * 1000L;
