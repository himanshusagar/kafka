 ...
 */
public class ProduceFollowerResponse extends AbstractResponse {
    public static final long INVALID_OFFSET = -1L;
    private final ProduceFollowerResponseData data;

    public ProduceFollowerResponse(ProduceFollowerResponseData ProduceFollowerResponseData) {
        super(ApiKeys.PRODUCE_FOLLOWER);
        this.data = ProduceFollowerResponseData;
    }
     ...
     */
    @Deprecated
    public ProduceFollowerResponse(Map<TopicPartition, PartitionResponse> responses) {
     ...
     */
    @Deprecated
    public ProduceFollowerResponse(Map<TopicPartition, PartitionResponse> responses, int throttleTimeMs) {
        this(toData(responses, throttleTimeMs));
    }

    private static ProduceFollowerResponseData toData(Map<TopicPartition, PartitionResponse> responses, int throttleTimeMs) {
        ...
        responses.forEach((tp, response) -> {
            ...
            tpr.partitionResponses()
                .add(new ProduceFollowerResponseData.PartitionProduceResponse()
                    ...
                    .setRecordErrors(response.recordErrors
                        .stream()
                        .map(e -> new ProduceFollowerResponseData.BatchIndexAndErrorMessage()
    ...
    @Override
    public ProduceFollowerResponseData data() {
        return this.data;
    }
    ...
    public static ProduceFollowerResponse parse(ByteBuffer buffer, short version) {
        return new ProduceFollowerResponse(new ProduceFollowerResponseData(new ByteBufferAccessor(buffer), version));
    }
